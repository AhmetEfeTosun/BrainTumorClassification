...
processor = AutoFeatureExtractor.from_pretrained('microsoft/swin-base-patch4-window7-224-in22k')
...
class ImageDataset(Dataset):
    def __init__(self, root_dir, extractor, class_names):
...
with open('swin_model_metrics.json', 'w') as f:
...
plt.tight_layout()
plt.savefig("swin_training_validation_plots.png")
...
plt.tight_layout()
plt.savefig("swin_normalized_confusion_matrix.png")
...
plt.tight_layout()
plt.savefig("swin_roc_curve.png")

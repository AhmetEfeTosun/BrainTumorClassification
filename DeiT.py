...
class ImageDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        inputs = self.processor(images=image, return_tensors="pt", size=(224, 224))
...
# Modeli kaydet
model_save_path = "deit_model.pth"
torch.save({
...
with open('deit_model_metrics.json', 'w') as f:
...
plt.tight_layout()
plt.savefig("deit_training_validation_plots.png")
...
plt.tight_layout()
plt.savefig("deit_normalized_confusion_matrix.png")
...
# Grafik kaydetme
plt.tight_layout()
plt.savefig("deit_roc_curve.png")

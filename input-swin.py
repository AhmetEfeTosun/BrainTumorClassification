...
model = AutoModelForImageClassification.from_pretrained(
    ...
    id2label=id2label,
    label2id=label2id,
    ignore_mismatched_sizes=True  # Boyut uyuşmazlıklarını görmezden gelir
)
...
checkpoint = torch.load("Results\\Yeniler\\SwiN\\swin_model.pth")  # Model ağırlıkları
...
# Görseli yükleyin
file_path = "C:\\Users\\PC\\Desktop\\YazlabDeneme\\test\\GliomaTumor\\resized_adjusted_glioma743.jpg"  # Test görseli

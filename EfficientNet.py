...
val_dir = 'C:\\Users\\PC\\Desktop\\YazlabDeneme\\val'
test_dir = 'C:\\Users\\PC\\Desktop\\YazlabDeneme\\test'
...
# Processor ve modelin yüklenmesi
...
class ImageDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Doğru: 'height' ve 'width' parametreleri kullanarak
        inputs = self.processor(images=image, return_tensors="pt", size={"height": 224, "width": 224})
...
with open('efficientnet_model_metrics.json', 'w') as f:
...
plt.tight_layout()
plt.savefig("efficientnet_training_validation_plots.png")
...
plt.tight_layout()
plt.savefig("efficientnet_normalized_confusion_matrix.png")
...
# Grafik kaydetme
plt.tight_layout()
plt.savefig("efficientnet_roc_curve.png")
